...
const TableroComponente = ({
    ...
    <MensajeVictoriaComponente turno={turno} completo={completo} reiniciarJuego={reiniciarJuego} />
    <div style={{
        display: "grid",
        gridTemplateColumns: "repeat(4, 1fr)"
    }}>
        {cartas && cartas.map((carta) => {
            return <CartaComponente key={carta.id} carta={carta} handleClick={handleClick} />
        })}
    </div>
</div> 
}
